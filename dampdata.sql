...
insert  into `tditemwork`(`id_item`,`name_ofitem`,`status`) values (1,'1 m Galian Strauss Tanah Keras Ø30 cm (Termasuk Alat Bor Strauss)',1);
...
insert  into `tdmasterkoefisien`(`code_koef`,`name_koefisien`) values ('bh','bh'),('btg','btg'),('kg','kg'),('lbr','lbr'),('Ls','Ls'),('Ltr','Ltr'),('m2','m2'),('m3','m3'),('MÂ¹','MÂ¹'),('ORG','org'),('rol','rol'),('sak','sak');
